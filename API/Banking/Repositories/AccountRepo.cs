...
public class AccountRepo : IAccountRepo
{
    ...
    public bool Insert(Account acct)
    {
        ...
        {
            string query =
                "INSERT INTO accounts(acctnumber,accttype,ifsccode,customerid,balance) VALUES(@acctNumber,@acctType,@ifscCode,@customerId,@balance)";
            MySqlCommand command = new MySqlCommand(query, con);
    ...
    public bool Update(Account acct)
    {
        ...
        {
            string query =
                "Update accounts SET acctnumber =@acctNumber,accttype=@acctType,ifsccode =@ifscCode,balance=@balance,customerid=@customerId WHERE id=@Id";
